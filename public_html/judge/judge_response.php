...
if($_GET){
	...
	switch($row['AUTO_RESPONSE']){
		...
		default:
			...
			echo "<tr><td bgcolor=$data_bg_color1>";
		        echo "<a name=$know_output href='judge_output.php?problem=$problem_name&judge_source=$know_output&sub_source=$source_file" . "_" . "$know_output&format=1'target='blank'>Output Files</a>";
		        echo "</td></tr></table>";
	}	
    }
